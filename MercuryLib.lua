...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. "Unique Hub - Premium" .. "</b> </font>"
...
function Library:create(options)
	...
	local homeButtonIcon = homeButton:object("ImageLabel", {
		...
		Image = "http://www.roblox.com/asset/?id=10731738718",
		Theme = {ImageColor3 = "StrongText"}
	})
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. "Unique Hub - Premium" .. "</b> </font>",
