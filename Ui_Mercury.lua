...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. "Everest Hub - Premium" .. "</b> </font>"
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("EverestUiSettings.json") then
			writefile("EverestUiSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("EverestUiSettings.json"))
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "<font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. "Everest Hub - Premium" .. "</b> </font>",
